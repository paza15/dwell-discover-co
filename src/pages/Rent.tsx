    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-20 bg-[image:var(--gradient-hero)] text-white">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-5xl font-bold mb-6">Properties For Rent</h1>
          <p className="text-xl text-white/90 max-w-2xl mx-auto">
            Find the perfect rental property that feels like home
          </p>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          {isLoading ? (
            ...
            <div className="text-center py-12">
              <p className="text-muted-foreground text-lg">No properties available for rent at the moment.</p>
            </div>
          )}
        </div>
      </section>
